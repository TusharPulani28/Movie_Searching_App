...
export const getGenres = createAsyncThunk("trackr/genres", async () => {
  const {
    data: { genres },
  } = await axios.get(
...
export const store = configureStore({
  reducer: {
    trackr: TrackrSlice.reducer,
  },
});

export const { setGenres, setMovies } = TrackrSlice.actions;
